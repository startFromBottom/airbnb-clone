...
SECRET_KEY = os.environ.get("DJANGO_SECRET", "mwdbahxhWnXXgJueDkuu5K2uDvdXsb2uPwQhfm2E")
...
STATIC_URL = "/static/"  # server url, not directory
...
if DEBUG is False:
    ...
    AWS_STORAGE_BUCKET_NAME = "airbnb-clone-eom123"
